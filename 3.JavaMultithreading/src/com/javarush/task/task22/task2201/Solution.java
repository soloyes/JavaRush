        ...
        try{
            ...
            switch (threadName) {
                case Solution.FIRST_THREAD_NAME:
                    ...
                    throw (TooShortStringFirstThreadException) new
                            TooShortStringFirstThreadException().initCause(e);
                case Solution.SECOND_THREAD_NAME:
                    throw (TooShortStringSecondThreadException) new
                            TooShortStringSecondThreadException().initCause(e);
                default:
