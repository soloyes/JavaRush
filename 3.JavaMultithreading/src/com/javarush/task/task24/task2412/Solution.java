...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int res1 =  stock1.get("name").toString().compareTo(stock2.get("name").toString());
                if (res1 != 0) return res1;

                Date date = (Date) stock1.get("date");
                Date date1 = (Date) stock2.get("date");

                res1 = date1.compareTo(date);
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Sirius Satellite", "SIRI", .07,
                new GregorianCalendar(1970, 12,01).getTime()));

        ////
        stocks.add(new Stock("Fake Sirius Satellite", "SIRI", -.06,
                new GregorianCalendar(1970, 12,01).getTime()));
